...
ActiveRecord::Schema[7.1].define(version: 20_250_812_090_704) do
  ...
  create_table 'notifications', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_type user_id], name: 'index_notifications_on_user'
  end
  ...
  create_table 'purchases', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[reader_id book_id], name: 'index_purchases_on_reader_id_and_book_id'
  ...
  create_table 'readers', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[provider uid], name: 'index_readers_on_provider_and_uid', unique: true
  ...
  create_table 'reading_statuses', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[reader_id book_id], name: 'index_reading_statuses_on_reader_id_and_book_id', unique: true
  end
